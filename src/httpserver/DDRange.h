...
FOUNDATION_EXPORT DDRange UISPEC_DDUnionRange(DDRange range1, DDRange range2);
FOUNDATION_EXPORT DDRange UISPEC_DDIntersectionRange(DDRange range1, DDRange range2);
FOUNDATION_EXPORT NSString *UISPEC_DDStringFromRange(DDRange range);
FOUNDATION_EXPORT DDRange UISPEC_DDRangeFromString(NSString *aString);
